### Etape 6 : modéliser l'émission de photons par une étoile en prenant en compte la diffusion et l'absorption et en faisant varier k_s (avec modification fausse pour expliquer)
...
for idx, k_s in enumerate(ks_values):
    ...
    for i in range(nb_photons):
        ...
        while True:
            ...
            if tau > tau_scatter:  
                ...
                if xmin <= r2[0] <= xmax and ymin <= r2[0] <= ymax and s_x > 0:
                    last_x, last_y = r2[0], r2[1]
                    last_event = 'direct'
                break
    ...
    # Ajouter les compteurs à la liste globale
...
plt.savefig('evol_ks_false.png', dpi=300, bbox_inches='tight')
